...
public class PolishCalc {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            sIn = d.readLine();
            StringBuilder changeStr = new StringBuilder(sIn);
            sIn = opn(changeStr);
